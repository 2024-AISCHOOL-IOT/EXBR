...
public class SensingData {
    ...
    public SensingData(int middle_flex_sensor, int middle_pressure_sensor, int ring_flex_sensor,
                       int ring_pressure_sensor, int pinky_flex_sensor, Timestamp timestamp) {
    ...
    public String toString() {
        return "ID: " + sensing_idx +
                ", Middle Flex: " + middle_flex_sensor +
                ", Middle Pressure: " + middle_pressure_sensor +
                ", Ring Flex: " + ring_flex_sensor +
                ", Ring Pressure: " + ring_pressure_sensor +
                ", Pinky Flex: " + pinky_flex_sensor +
                ", Timestamp: " + timestamp;
    }
}
