...
public class DataActivity extends AppCompatActivity implements ReadHelper.SensorDataCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readButton.setOnClickListener(v -> readHelper.startLearning());
        stopButton.setOnClickListener(v -> readHelper.stopLearning());
    }
    ...
    public void onSensorDataReceived(int[] sensorData) {
        ...
        runOnUiThread(() -> {
            ...
            // 학습한 데이터 수를 업데이트
            int sensingCount = readHelper.getSensingCount();
